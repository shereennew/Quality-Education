...
try {
    ...
    $pdo->exec("INSERT INTO teacher_quiz_feedback (teacher_id, student_id, chapter_name, subtopic_name, comment) VALUES
        (1, 2, 'Ancient Pyramid: Fundamentals', '1.1', 'Good work, but review how to add fractions with the same denominator.'),
        (1, 3, 'Ancient Pyramid: Fundamentals', '1.1', 'Excellent work on this subtopic. Keep up the good work!'),
        (1, 1, 'Ancient Pyramid: Fundamentals', '1.1', 'Take your time and review the basic steps for adding fractions.'),
        (1, 3, 'Ancient Pyramid: Fundamentals', '1.2', 'Good effort. Please review subtraction of fractions with the same denominator.'),
        (1, 2, 'Cherry Blossom: Multiplications', '2.1', 'Remember to divide both the numerator and denominator by the same common factor when simplifying fractions.')");
