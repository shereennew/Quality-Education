        ...
        <div class="w-full max-w-[85rem] mx-auto px-8 flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center justify-center flex-1 mx-6">
                ...
                <ul class="flex items-center gap-3 text-lg font-bold">
                    ...
                    <!-- HOME -->
                    <li>
                        <a href="index.php" class="flex items-center px-6 py-3 rounded-2xl
                    ...
                    <!-- DISCUSSION -->
                    <li>
                        <a href="discussion.php" class="flex items-center px-5 py-3 rounded-2xl
                              text-pastel-text
                    ...
                    <!-- MODULES -->
                    <li>
                        <a href="module.php" class="flex items-center px-5 py-3 rounded-2xl
                              text-pastel-text
                              hover:bg-pastel-card
                              hover:text-pastel-primary
                              hover:shadow-sm
                    ...
                    <!-- QUIZZES -->
                    <li>
                        <a href="quiz.php" class="flex items-center px-5 py-3 rounded-2xl
                              text-pastel-text
                              hover:bg-pastel-card
                              hover:text-pastel-primary
                              hover:shadow-sm
    ...
    <a href="history.php" class="flex items-center px-5 py-3 rounded-2xl
        ...
        <span>History</span>
            ...
            <div class="flex items-center flex-shrink-0">
                ...
                <button id="user-menu-button" data-dropdown-toggle="user-dropdown" type="button" class="flex items-center gap-3
                    py-2.5 px-4
                    bg-pastel-card
                    ...
                    <div class="w-10 h-10 rounded-full
                            ...
                            font-black text-pastel-text text-lg">
                ...
                <div class="z-50 hidden
                    ...
                    <ul class="p-2 text-base text-pastel-text font-medium" aria-labelledby="user-menu-button">
                        ...
                        <li>
                            <a href="#" class="block w-full px-4 py-2.5
                                  hover:bg-pastel-bg
                                  hover:text-pastel-primary
                                  rounded-xl
                                  transition-colors">
        ...
        <div class="hidden w-full md:hidden
            ...
            <ul class="flex flex-col gap-2
                ...
                <li>
                    <a href="index.php" class="block py-3 px-4
                          text-white
                          bg-pastel-primary
                          rounded-xl
                          shadow-sm">
                ...
                <li>
                    <a href="discussion.php" class="block py-3 px-4
                          text-pastel-text
                          rounded-xl
                          hover:bg-pastel-bg
                          hover:text-pastel-primary
                ...
                <li>
                    <a href="module.php" class="block py-3 px-4
                          text-pastel-text
                          rounded-xl
                          hover:bg-pastel-bg
                          hover:text-pastel-primary
                ...
                <li>
                    <a href="quiz.php" class="block py-3 px-4
                          text-pastel-text
                          rounded-xl
                          hover:bg-pastel-bg
                          hover:text-pastel-primary
