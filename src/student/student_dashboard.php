...
<body class="bg-pastel-bg text-pastel-text font-sans min-h-screen flex flex-col">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <button class="text-xs bg-white text-pastel-text px-3 py-1.5 rounded-lg border border-blue-100 hover:bg-slate-50 transition">Logout</button>
                </div>
    ...
    <main class="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <!-- Header Banner -->
        <div class="bg-gradient-to-r from-pastel-nav to-white p-6 rounded-2xl border border-blue-100 shadow-sm mb-8 flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-pastel-text capitalize">
                    <?= htmlspecialchars($nav_items[$current_page] ?? 'Dashboard') ?> Section
                </h1>
                <p class="text-sm text-slate-500 mt-1">Keep up the great work! You have completed 3 adaptive tasks today.</p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 bg-pastel-card p-6 rounded-2xl shadow-sm border border-blue-100">
                    <div class="flex justify-between items-center mb-4">
                        <span class="text-xs font-semibold px-2.5 py-1 rounded-md bg-blue-50 text-pastel-hover">Module 3: Fractions</span>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
                        <button onclick="selectOption(this)" class="option-btn p-3 text-left border-2 border-slate-100 rounded-xl hover:border-pastel-primary hover:bg-blue-50/50 transition font-medium">
                            A) $\frac{3}{9}$
                        </button>
                        <button onclick="selectOption(this)" class="option-btn p-3 text-left border-2 border-slate-100 rounded-xl hover:border-pastel-primary hover:bg-blue-50/50 transition font-medium">
                            B) $\frac{2}{3}$
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-slate-100">
                        ...
                        <button class="bg-pastel-primary hover:bg-pastel-hover text-white px-6 py-2 rounded-xl font-medium text-sm transition shadow-sm">Submit Answer</button>
                    </div>
                </div>
        ...
        <?php else: ?>
            ...
            <div class="bg-pastel-card p-12 rounded-2xl shadow-sm border border-blue-100 text-center">
                <p class="text-slate-400">Content for <span class="font-semibold text-pastel-text capitalize"><?= htmlspecialchars($current_page) ?></span> goes here.</p>
            </div>
        <?php endif; ?>
